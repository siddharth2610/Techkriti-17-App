...
public class MapsActivity1 extends FragmentActivity implements OnMapReadyCallback  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        extra=intent.getExtras().getString("Snippet");
        ...
        String[] itemL = new String[] {location, "IIT Kanpur","VISITORS HOSTEL", "NEW SAC", "LHC" ,"HALL 3","OUTREACH AUDI","AIR STRIP","HALL 5","HALL 2","HALL 4","GH","MAIN AUDI","HALL 1","OAT","CCD","FOOTBALL GROUND","FESTIVAL GROUND"};
        ...
        staticSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if ((isInternetPresent==false)||(item.compareTo("MAIN AUDI") == 0)||(item.compareTo("HALL 3")==0)||(item.compareTo("HALL 2")==0)||(item.compareTo("HALL 4")==0)||(item.compareTo("HALL 5")==0)||(item.compareTo("HALL 1")==0)||(item.compareTo("HALL 10")==0)||(item.compareTo("CCD") ==0)||(item.compareTo("OAT") ==0)||(item.compareTo("FOOTBALL GROUND") ==0)||(item.compareTo("FESTIVAL GROUND")==0))
                    me(item);
                else if (item.compareTo("IIT Kanpur") != 0) {
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
String locations=location+"IIT Kanpur";
new GeocoderTask().execute(locations);
