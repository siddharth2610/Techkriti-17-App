 ...
 */
public class SimpleRecycleAdapter0 extends RecyclerView.Adapter<SimpleRecycleAdapter0.VersionViewHolder> {
    ...
    public SimpleRecycleAdapter0(Context context) {
        isHomeList = true;
    ...
    public SimpleRecycleAdapter0(List<String> versionModels) {
        isHomeList = false;
