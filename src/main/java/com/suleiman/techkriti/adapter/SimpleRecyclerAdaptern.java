 ...
 */
public class SimpleRecyclerAdaptern extends RecyclerView.Adapter<SimpleRecyclerAdaptern.VersionViewHolder> {
    ...
    public SimpleRecyclerAdaptern(Context context) {
        isHomeList = true;
    ...
    public SimpleRecyclerAdaptern(List<String> versionModels) {
        isHomeList = false;
